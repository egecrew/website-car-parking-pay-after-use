    ...
    <div className="app">
      ...
      <header className="header">
        <div className="container">
          <div className="logo">🏢 Car Parking (Pay after use)</div>
        ...
        <div className="container">
          ...
          <div className="about-content">
            ...
            <div style={{marginTop: '1.5rem', padding: '1rem', backgroundColor: '#f8f9fa', borderRadius: '8px'}}>
                ...
                <br />
                <a href="https://egecrew.github.io/website-car-parking-pay-after-use/" target="_blank" rel="noopener noreferrer" style={{color: '#0066cc'}}>
        ...
        <div className="container">
          ...
          <div className="services-grid">
            ...
            <div className="service-card">
              ...
              <p>Car Parking (Pay after use)in büyümesine katkı sağlayacak stratejiler ve çözümler.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="contact-content">
            <div className="contact-info">
              ...
              <div className="info-item">
                ...
                <div>
                  <h3>Email</h3>
                  <p>bodrumkemanciticaret@gmail.com</p>
                </div>
              </div>
              ...
              <div className="info-item">
                ...
                <div>
                  <h3>Adres</h3>
                  <p>Çarşı, Cevat Şakir Cd. No:46, 48400 Bodrum/Muğla, Türkiye</p>
                </div>
              </div>
      ...
      <footer className="footer">
        <div className="container">
          <div className="footer-content">
            ...
            <div className="footer-section">
              <h4>İletişim</h4>
              <p>+902523133553<br/>bodrumkemanciticaret@gmail.com</p>
            </div>
          </div>
          <div className="footer-bottom">
            <p>&copy; 2026 Car Parking (Pay after use). Tüm hakları saklıdır.</p>
